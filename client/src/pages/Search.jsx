        ...
        <form className='flex flex-col gap-8'>
          ...
          <div className='flex gap-2 flex-wrap items-center'>
            ...
            <div className='flex gap-2'>
              <input type='checkbox' id='all' className='w-5 cursor-pointer' />
              <span>Rent & Sale</span>
            </div>
            <div className='flex gap-2'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <select id='sort_order' className='border rounded-lg p-3 cursor-pointer text-center text-sm md:text-zinc-700'>
